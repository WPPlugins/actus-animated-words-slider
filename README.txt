...
Donate link: http://wp.actus.works/
Tags: slider, photo slider, effects, photographic, post, page, images, animation, words, ajax, jquery, actus
...
4. Use the shortcode **`[actus_awslider]`** to embed the animated tag cloud anywhere in your pages.



== Usage ==

* Use our shortcode **`[actus_awslider]`** to place the plugin anywhere on your page.
<br>
...
<br>
You can use the shortcode without parameters to use the settings defined in the edit post/page, or you can provide parameters to override those settings. You can use one or more parameters like that **`[actus_awslider height='400' words='off']`**.
...
You can find more details about the plugin settings in our website [ACTUS Animated Words Slider](http://wp.actus.works/actus-animated-words-slider/ "ACTUS WordPress Plugins").



== Screenshots ==
1. The slider settings on the edit post/page.
2. The slider options.
3. The select images panel.
4. The select words to be animated panel.
5. The slider settings on the edit post/page expanded.
